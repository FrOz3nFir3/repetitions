      ...
      <Modal isOpen={isOpen} onClose={onClose} title={`Edit Quiz`}>
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
            Update the quiz question, answer, and options below. and click on
            Update Quiz to save changes.
          </p>
        </div>
          ...
          <div className="space-y-4">
            ...
            {options.length < minimumOptions - 1 && (
              <button
                ...
                disabled={isLoading}
                className="flex items-center space-x-2 text-sm text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 disabled:opacity-50"
              >
