  ...
  <div>
    ...
    <div className="mb-6">
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400">
        Search through your quiz collection or filter by specific flashcards to
        find what you need.
      </p>
    </div>
    ...
    <div className="space-y-4">
      <div className="flex flex-col lg:flex-row gap-4">
        ...
        <div className="flex items-center gap-3 lg:w-80">
          <div className="p-3 bg-gradient-to-br from-indigo-100 to-purple-100 dark:from-indigo-900/50 dark:to-purple-900/50 rounded-xl shadow-md">
            <FunnelIcon className="h-5 w-5 text-indigo-600 dark:text-indigo-400" />
          </div>
